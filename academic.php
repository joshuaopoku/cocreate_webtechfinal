...
<html lang="en">
  <head>
    ...
    <title>Academic Projects &#8211; Co-create</title>
  </head>
  <body>
      ...
      <section class="py-5 text-center container">
        <div class="row py-lg-5">
          <div class="col-lg-6 col-md-8 mx-auto">
            <h1 class="fw-light">Academic Projects</h1>
            <p class="lead text-muted">Something short and leading about the collection</p>
            <p>
              <a href="nproject.php" class="btn btn-primary my-2 pmain-btn">Create new project</a>
              <a href="dashboard.php" class="btn btn-secondary my-2 nmain-btn">Visit my dashboard</a>
            </p>
          </div>
        </div>
      </section>
      ...
      <div class="album py-5 bg-light">
        <div class="container">
          ...
          <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
            ...
            $duplicate_user_result= mysqli_query($conn,$query) or die(mysqli_error($conn));
            $rows_fetched= mysqli_num_rows($duplicate_user_result);
            if ($rows_fetched > 0){
              while($row = $duplicate_user_result->fetch_assoc()){
                
                echo '<div class="col">

                <div class="card shadow-sm">
                  <svg class="bd-placeholder-img card-img-top" width="100%" height="225" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><image style="object-fit: cover !important" href="https://images.unsplash.com/photo-1633113090205-cc1ac795b5f9?ixlib=rb-1.2.1&ixid=MnwxMjA3fDF8MHxlZGl0b3JpYWwtZmVlZHwyMXx8fGVufDB8fHx8&auto=format&fit=crop&w=600&q=60" height="100%" width="100%"/><text x="50%" y="50%" fill="#eceeef" dy=".3em">'.$row["project_name"].'</text></svg>
      
                  <div class="card-body">
                    <p class="card-text">'.$row["project_des"].'</p>
                    <div class="d-flex justify-content-between align-items-center">
                      <div class="btn-group">
                        <button type="button" class="btn btn-sm btn-outline-secondary">Review</button>
                        <button type="button" class="btn btn-sm btn-outline-secondary">Member request</button>
                      </div>
            ...
            ?>
             ...
             <!-- <div class="col">
              <div class="card shadow-sm">
                ...
                <svg class="bd-placeholder-img card-img-top" width="100%" height="225" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><image style="object-fit: cover !important" href="img\academic3.jpg" height="100%" width="100%"/><text x="50%" y="50%" fill="#eceeef" dy=".3em">Project Name</text></svg>
